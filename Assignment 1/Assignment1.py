...
pepperIm = cv2.imread("C:/ROBIUL/Courses Fall 2024/Computer Vision (CS5680)/Assignment 1/peppers.bmp", 1)
pepperIm = cv2.cvtColor(pepperIm, cv2.COLOR_BGR2RGB)
lenaIm = cv2.imread("C:/ROBIUL/Courses Fall 2024/Computer Vision (CS5680)/Assignment 1/Lena.jpg", 0)
